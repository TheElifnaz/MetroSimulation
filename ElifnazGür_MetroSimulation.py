...
class MetroAgi:
    ...
    def en_hizli_rota_bul(self, baslangic_id: str, hedef_id: str) -> Optional[Tuple[List[Istasyon], int]]:
        ...
        def hesapla_heuristic(istasyon: Istasyon) -> int:
            return 0
        ...
        while pq:
            _, _, mevcut_istasyon, rota, toplam_sure = heapq.heappop(pq)
            ...
            if mevcut_istasyon not in ziyaret_edildi:
                ...
                for komsu, sure in mevcut_istasyon.komsular:
                    if komsu not in ziyaret_edildi:
                        ...
                        heapq.heappush(pq, (yeni_toplam_sure + hesapla_heuristic(komsu), id(komsu), komsu, rota + [komsu], yeni_toplam_sure))
